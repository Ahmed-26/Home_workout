...
public class FirstActivity extends AppCompatActivity {
    ...
    public void saveBMI(EditText height, EditText weight) {
        ...
        editor.putString("GROWTH", height.getText().toString());
        editor.putString("LIBRA", weight.getText().toString());
        editor.apply();
    }
    public void openMainPozActivity(){
        Intent intent = new Intent(this, TreningActivity.MainActivity.class);
