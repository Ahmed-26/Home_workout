...
public class TableCollectionInteger {
    ...
    TableCollectionInteger(int ładunek) {
        ...
        if( ładunek < 1 ) throw new ArrayCollectionError("Charge cannot be less than 1, you specified: "+ładunek);
        this.ładunek = ładunek;
    ...
    public void add(Integer Integer){
        ...
        System.out.println("The item has been added under the index: "+(this.indeks+1)+".");
        NextFree();
    ...
    public void add(Integer Integer, int indeks ){
        ...
        if( Tablica[indeks] != null ){
            System.out.println("### Index: "+indeks+", is busy item has been added to the first free slot:"+this.indeks+".");
            Tablica[this.indeks] = Integer;
        } else {
            Tablica[indeks] = Integer;
            System.out.println("The item has been added under the index: "+(indeks+1)+".");
        }
        NextFree();
    ...
    public void delete(int indeks){
        ...
        try {
            if ( Tablica[indeks] != null ){
                ...
                System.out.println("### Under the index: "+indeks+", no item is found");
            }

        } catch (ArrayIndexOutOfBoundsException w){
            throw new ArrayCollectionError("The index from which you tried to delete an item is invalid: "+indeks+".");
        }
    ...
    public void deleteAll(){
        ...
        indeks = 0;
        System.out.println("### All items of the Collection: "+this.hashCode()+", were removed!");
    ...
    public String show(int indeks){
        ...
        try{
            ...
            throw new ArrayCollectionError("You tried to get an element at index from outside of an array");
        }
    ...
    public String showAll(){
        ...
        int i;
        String result = "Board collection number:'"+this.hashCode()+"':\n";
