...
public class ReportActivity extends AppCompatActivity {
    ...
    public static final String BMI_CATEGORY_HEALTHY = "Correct weight";
    public static final String BMI_CATEGORY_OVERWEIGHT = "Overweight";
    public static final String BMI_CATEGORY_OBESE = "Extreme obesity";
    TextView bmi;
    TextView kat;
    Button policz;
    EditText wzrostpob;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String waga = preferences.getString("LIBRA","70");
        String wzrost = preferences.getString("GROWTH","180" );
    ...
    public void saveBMI(EditText wzrost, EditText waga) {
        ...
        editor.putString("GROWTH", wzrost.getText().toString());
        editor.putString("LIBRA", waga.getText().toString());
        editor.apply();
    }
}